...
| `category`               | No        | Override the default rule category (e.g. `"documentation"`, `"naming"`). Shown in structured output (JSON, CSV, NDJSON) only. See [Rule Categories](/docs/rules#rule-categories)                                                                          |
