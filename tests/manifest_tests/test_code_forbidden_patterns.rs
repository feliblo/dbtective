...
#[test]
fn test_code_forbidden_patterns_models() {
    let manifest = r#"{
  "metadata": {
...
#[test]
fn test_code_forbidden_patterns_no_violations() {
    let manifest = r#"{
  "metadata": {
    "dbt_schema_version": "https://schemas.getdbt.com/dbt/manifest/v12.json",
    "dbt_version": "1.10.0",
...
#[test]
fn test_code_forbidden_patterns_macros() {
    let manifest = r#"{
  "metadata": {
    "dbt_schema_version": "https://schemas.getdbt.com/dbt/manifest/v12.json",
    "dbt_version": "1.10.0",
...
#[test]
fn test_code_forbidden_patterns_case_insensitive_default() {
    let manifest = r#"{
  "metadata": {
    "dbt_schema_version": "https://schemas.getdbt.com/dbt/manifest/v12.json",
    "dbt_version": "1.10.0",
...
#[test]
fn test_code_forbidden_patterns_case_sensitive_no_match() {
    let manifest = r#"{
  "metadata": {
    "dbt_schema_version": "https://schemas.getdbt.com/dbt/manifest/v12.json",
    "dbt_version": "1.10.0",
...
#[test]
fn test_code_forbidden_patterns_case_sensitive_exact_match() {
    let manifest = r#"{
  "metadata": {
    "dbt_schema_version": "https://schemas.getdbt.com/dbt/manifest/v12.json",
    "dbt_version": "1.10.0",
